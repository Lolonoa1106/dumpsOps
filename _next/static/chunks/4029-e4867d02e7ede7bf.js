    ...
    4029: (e, t, o) => {
      ...
      function _(e, t, o) {
        let n,
          ...
          y = r.y + r.height / 2 - l.height / 2,
          w = r[s] / 2 - l[s] / 2;
        switch (a) {
          case "top":
            n = { x: d, y: r.y - l.height };
            break;
          case "bottom":
            n = { x: d, y: r.y + r.height };
            break;
          case "right":
            n = { x: r.x + r.width, y: y };
            break;
      ...
      async function E(e, t) {
        var o;
        void 0 === t && (t = {});
        let { x: n, y: r, platform: l, rects: i, elements: c, strategy: s } = e,
          {
          ...
          h = g(m),
          v = c[p ? ("floating" === f ? "reference" : "floating") : f],
          y = b(
            await l.getClippingRect({
              element:
                null ==
                  (o = await (null == l.isElement ? void 0 : l.isElement(v))) ||
                o
                  ? v
                  : v.contextElement ||
          ...
          w =
            "floating" === f
              ...
              : i.reference,
          _ = await (null == l.getOffsetParent
            ? void 0
            : l.getOffsetParent(c.floating)),
          x = ((await (null == l.isElement ? void 0 : l.isElement(_))) &&
            (await (null == l.getScale ? void 0 : l.getScale(_)))) || {
            x: 1,
            y: 1,
          },
          E = b(
        ...
        return {
          top: (y.top - E.top + h.top) / x.y,
          bottom: (E.bottom - y.bottom + h.bottom) / x.y,
          left: (y.left - E.left + h.left) / x.x,
          right: (E.right - y.right + h.right) / x.x,
        };
      }
      async function S(e, t) {
        let { placement: o, platform: n, elements: r } = e,
          l = await (null == n.isRTL ? void 0 : n.isRTL(r.floating)),
          i = f(o),
          c = p(o),
          s = "y" === v(o),
        ...
        return (
          c && "number" == typeof w && (y = "end" === c ? -1 * w : w),
          s ? { x: y * u, y: h * a } : { x: h * a, y: y * u }
        );
      }
      function A() {
      ...
      function O(e) {
        return !!A() && (e instanceof Node || e instanceof T(e).Node);
      }
      function L(e) {
        return !!A() && (e instanceof Element || e instanceof T(e).Element);
      }
      function C(e) {
        return (
          !!A() && (e instanceof HTMLElement || e instanceof T(e).HTMLElement)
        );
      }
      function N(e) {
        return (
      ...
      function D(e) {
        let { overflow: t, overflowX: o, overflowY: n, display: r } = B(e);
        return (
      ...
      function M(e) {
        ...
        let t = e.assignedSlot || e.parentNode || (N(e) && e.host) || k(e);
        return N(t) ? t.host : t;
      }
      function P(e, t, o) {
        var n;
      ...
      function F(e) {
        let t = B(e),
          ...
          s = i(o) !== l || i(n) !== c;
        return s && ((o = l), (n = c)), { width: o, height: n, $: s };
      }
      function V(e) {
      ...
      function q(e) {
        ...
        let o = t.getBoundingClientRect(),
          { width: n, height: r, $: l } = F(t),
          c = (l ? i(o.width) : o.width) / n,
      ...
      function Y(e, t, o, n) {
        ...
        let l = e.getBoundingClientRect(),
          ...
          c = s(1);
        t && (n ? L(n) && (c = q(n)) : (c = q(e)));
        let a = (void 0 === (r = o) && (r = !1), n && (!r || n === T(i)) && r)
            ? X(i)
            : s(0),
          u = (l.left + a.x) / c.x,
          d = (l.top + a.y) / c.y,
        ...
        if (i) {
          ...
          for (; r && n && t !== o; ) {
            let e = q(r),
              ...
              n = B(r),
              l = t.left + (r.clientLeft + parseFloat(n.paddingLeft)) * e.x,
        ...
        return b({ width: f, height: p, x: u, y: d });
      }
      function Z(e, t) {
        let o = W(e).scrollLeft;
        return t ? t.left + o : Y(k(e)).left + o;
      }
      function G(e, t, o) {
        void 0 === o && (o = !1);
        let n = e.getBoundingClientRect();
        return {
          x: n.left + t.scrollLeft - (o ? 0 : Z(e, n)),
          y: n.top + t.scrollTop,
        };
      }
      function U(e, t, o) {
        ...
        if ("viewport" === t)
          n = (function (e, t) {
            ...
            return { width: l, height: i, x: c, y: s };
          })(e, o);
        else if ("document" === t)
          n = (function (e) {
            let t = k(e),
            ...
            return (
              "rtl" === B(n).direction &&
                (c += l(t.clientWidth, n.clientWidth) - r),
              { width: r, height: i, x: c, y: s }
            );
          })(k(e));
        else if (L(t))
          n = (function (e, t) {
            ...
            return { width: i, height: c, x: r * l.x, y: n * l.y };
          })(t, o);
        else {
          let o = X(e);
      ...
      function Q(e, t) {
        if (!C(e) || "fixed" === B(e).position) return null;
        if (t) return t(e);
      ...
      function ee(e, t) {
        ...
        let n = Q(e, t);
        for (; n && ["table", "td", "th"].includes(R(n)) && J(n); ) n = Q(n, t);
        return n && H(n) && J(n) && !j(n)
          ? o
          : n ||
              (function (e) {
                let t = M(e);
      ...
      let et = async function (e) {
          ...
          return {
            reference: (function (e, t, o) {
              let n = C(t),
                ...
                a = s(0);
              if (n || (!n && !l))
                if ((("body" !== R(t) || D(r)) && (c = W(t)), n)) {
                  let e = Y(t, !0, l, t);
                  (a.x = e.x + t.clientLeft), (a.y = e.y + t.clientTop);
                } else r && (a.x = Z(r));
              l && !n && r && (a.x = Z(r));
              let u = !r || n || l ? s(0) : G(r, c);
              return {
                x: i.left + c.scrollLeft - a.x - u.x,
                y: i.top + c.scrollTop - a.y - u.y,
                width: i.width,
                height: i.height,
              };
        ...
        eo = {
          convertOffsetParentRelativeRectToViewportRelativeRect: function (e) {
            ...
            if (
              (f || (!f && !l)) &&
              (("body" !== R(n) || D(i)) && (a = W(n)), C(n))
            ) {
              let e = Y(n);
              (u = q(n)), (d.x = e.x + n.clientLeft), (d.y = e.y + n.clientTop);
            }
            let p = !i || f || l ? s(0) : G(i, a, !0);
            return {
              width: o.width * u.x,
              height: o.height * u.y,
              x: o.x * u.x - a.scrollLeft * u.x + d.x + p.x,
              y: o.y * u.y - a.scrollTop * u.y + d.y + p.y,
            };
          },
                  ...
                  ? $(t)
                    ...
                    : (function (e, t) {
                        ...
                        let n = P(e, [], !1).filter(
                          ...
                          r = null,
                          l = "fixed" === B(e).position,
                          i = l ? M(e) : e;
                        for (; L(i) && !H(i); ) {
                          let t = B(i),
                            o = j(i);
                          o || "fixed" !== t.position || (r = null),
                            (
                              l
                                ? !o && !r
                                : (!o &&
      ...
      let er = function (e) {
          return (
            void 0 === e && (e = 0),
            {
              ...
              async fn(t) {
                var o, n;
                let { x: r, y: l, placement: i, middlewareData: c } = t,
                  s = await S(t, e);
                return i === (null == (o = c.offset) ? void 0 : o.placement) &&
                  null != (n = c.arrow) &&
                  n.alignmentOffset
                  ? {}
                  : { x: r + s.x, y: l + s.y, data: { ...s, placement: i } };
              },
            }
          );
        },
          ...
          return (
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                ...
                let _ = a.fn({ ...t, [w]: g, [y]: b });
                return {
                  ..._,
                  data: { x: _.x - o, y: _.y - n, enabled: { [w]: c, [y]: s } },
                };
              },
            }
          );
          ...
          return (
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                ...
                if (null != (o = a.arrow) && o.alignmentOffset) return {};
                let L = f(s),
                  C = v(g),
                  N = f(g) === g,
                  D = await (null == b.isRTL ? void 0 : b.isRTL(_.floating)),
                  $ =
                    A ||
                    (N || !k
                      ? [w(g)]
                    ...
                    let n = p(e),
                      ...
                      i =
                        "x" === r
                          ...
                          : "top";
                    return (
                      t.reference[l] > t.floating[l] && (i = w(i)), [i, w(i)]
                    );
                  })(s, u, D);
                  B.push(H[e[0]], H[e[1]]);
                }
                if (
                  ((W = [...W, { placement: s, overflows: B }]),
                  !B.every((e) => e <= 0))
                ) {
                  let e = ((null == (r = a.flip) ? void 0 : r.index) || 0) + 1,
                    t = I[e];
                  if (t) {
                    let o = "alignment" === S && C !== v(t),
                      n = (null == (i = W[0]) ? void 0 : i.overflows[0]) > 0;
                    if (!o || n)
                      return {
        ...
        ec = (e) => ({
          ...
          async fn(t) {
            ...
            let w = g(y),
              ...
              R = c.reference[x] + c.reference[_] - b[_] - c.floating[x],
              T = b[_] - c.reference[_],
              k = await (null == s.getOffsetParent
                ? void 0
                : s.getOffsetParent(f)),
              O = k ? k[A] : 0;
            (O && (await (null == s.isElement ? void 0 : s.isElement(k)))) ||
              (O = a.floating[A] || c.floating[x]);
            let L = O / 2 - E[x] / 2 - 1,
              C = r(w[S ? "top" : "left"], L),
              N = r(w[S ? "bottom" : "right"], L),
              D = O - E[x] - N,
              $ = O / 2 - E[x] / 2 + (R / 2 - T / 2),
              j = l(C, r($, D)),
              I =
        ...
        es = (e, t, o) => {
          let n = new Map(),
            r = { platform: eo, ...o },
            l = { ...r.platform, _c: n };
          return x(e, t, { ...r, platform: l });
        };
      var ea = o(29300),
        eu = o(49509);
      let ed = { core: !1, base: !1 };
      function ef({
        css: e,
        ...
        if (
          ...
          ("base" !== o &&
            void 0 !== eu &&
            (null == (l = null == eu ? void 0 : eu.env)
              ? void 0
              : l.REACT_TOOLTIP_DISABLE_BASE_STYLES))
        )
          return;
        "core" === o && (t = "react-tooltip-core-styles"), n || (n = {});
        let { insertAt: i } = n;
      ...
      let ep = async ({
          ...
          middlewares: i = [
            er(Number(r)),
            ei({ fallbackAxisSideDirection: "start" }),
            el({ padding: 5 }),
          ],
          border: c,
        }) =>
          e && null !== t
            ? o
              ? (i.push(ec({ element: o, padding: 5 })),
                es(e, t, { placement: n, strategy: l, middleware: i }).then(
                  ({ x: e, y: t, placement: o, middlewareData: n }) => {
                    var r, l;
                    let i = { left: `${e}px`, top: `${t}px`, border: c },
                      { x: s, y: a } =
                        null != (r = n.arrow) ? r : { x: 0, y: 0 },
                      u =
                        null !=
                        (l = {
                          top: "bottom",
        ...
        eh = (e, t, o) => {
          let n = null,
            r = function (...r) {
              ...
              o && !n && (e.apply(this, r), (n = setTimeout(l, t))),
                o || (n && clearTimeout(n), (n = setTimeout(l, t)));
            };
          return (
            (r.cancel = () => {
        ...
        ev = (e) => null !== e && !Array.isArray(e) && "object" == typeof e,
        ey = (e, t) => {
          if (e === t) return !0;
          if (Array.isArray(e) && Array.isArray(t))
            return e.length === t.length && e.every((e, o) => ey(e, t[o]));
          if (Array.isArray(e) !== Array.isArray(t)) return !1;
          if (!ev(e) || !ev(t)) return e === t;
          let o = Object.keys(e),
            n = Object.keys(t);
          return o.length === n.length && o.every((o) => ey(e[o], t[o]));
        },
        ew = (e) => {
        ...
        eb = "undefined" != typeof window ? n.useLayoutEffect : n.useEffect,
        e_ = (e) => {
        ...
        eE = (0, n.createContext)({ getTooltipData: () => ex });
      function eS(e = "DEFAULT_TOOLTIP_ID") {
        return (0, n.useContext)(eE).getTooltipData(e);
      }
      var eA = {
      ...
      let eT = ({
          ...
          let J = (0, n.useRef)(null),
            ...
            [es, eu] = (0, n.useState)(!1),
            [ed, ef] = (0, n.useState)(null),
            em = (0, n.useRef)(!1),
            ev = (0, n.useRef)(null),
            { anchorRefs: ew, setActiveAnchor: ex } = eS(t),
            eE = (0, n.useRef)(!1),
            [eT, ek] = (0, n.useState)([]),
            eO = (0, n.useRef)(!1),
            ...
            eC =
              ...
              (null == T ? void 0 : T.dblclick) ||
              (null == T ? void 0 : T.mousedown),
            eN = T
              ? { ...T }
              : {
                  mouseover: !0,
          ...
          !O &&
            eL &&
            Object.assign(eD, { mouseleave: !1, blur: !1, mouseout: !1 });
          let e$ = L
            ? { ...L }
            : {
                escape: S || !1,
          ...
          let ej = (e) => {
            eO.current &&
              (e && eu(!0),
              setTimeout(() => {
                eO.current && (null == z || z(e), void 0 === W && ec(e));
              }, 10));
          };
          (0, n.useEffect)(() => {
            ...
            (0, n.useEffect)(() => {
              ei !== em.current &&
                ((e_(eo), (em.current = ei), ei)
                  ? null == $ || $()
                  : (eo.current = setTimeout(
                      () => {
                        eu(!1), ef(null), null == j || j();
                      },
                      ((e) => {
                        let t = e.match(/^([\d.]+)(ms|s)$/);
                        if (!t) return 0;
                        let [, o, n] = t;
                        return Number(o) * ("ms" === n ? 1 : 1e3);
                      })(
          ...
          let eI = (e) => {
            ...
            eW = (e) => {
              var t;
              if (!e) return;
              let o = null != (t = e.currentTarget) ? t : e.target;
              if (!(null == o ? void 0 : o.isConnected))
                return q(null), void ex({ current: null });
              w ? eH() : ej(!0), q(o), ex({ current: o }), e_(et);
            },
            eM = () => {
              E ? eB(g || 100) : g ? eB() : ej(!1), e_(ee);
            },
            eP = ({ x: e, y: t }) => {
              var o;
              ep({
                place: null != (o = null == ed ? void 0 : ed.place) ? o : d,
                offset: f,
                elementReference: {
            ...
            eF = (e) => {
              ...
              let o = e.target;
              o.isConnected &&
                (null == (t = J.current) || !t.contains(o)) &&
                ([document.querySelector(`[id='${a}']`), ...eT].some((e) =>
            ...
            eY = (0, n.useCallback)(() => {
              var e, t;
              let o = null != (e = null == ed ? void 0 : ed.position) ? e : D;
              o
                ? eP(o)
                : b
                ? ev.current && eP(ev.current)
                : (null == F ? void 0 : F.isConnected) &&
                  ep({
                    place: null != (t = null == ed ? void 0 : ed.place) ? t : d,
                    offset: f,
                    elementReference: F,
                    tooltipReference: J.current,
                    tooltipArrowReference: Q.current,
          ...
          (0, n.useEffect)(() => {
            ...
            let o = new Set(ew);
            eT.forEach((e) => {
              (null == I ? void 0 : I(e)) || o.add({ current: e });
            });
            let n = document.querySelector(`[id='${a}']`);
            !n || (null == I ? void 0 : I(n)) || o.add({ current: n });
            let i = () => {
                ej(!1);
              },
              s = eg(F),
            ...
            let p = [],
              m = (e) =>
                !!(
                  ...
                  (null == F ? void 0 : F.contains(e.target))
                ),
              h = (e) => {
                (ei && m(e)) || eW(e);
              },
              ...
              w = ["click", "dblclick", "mousedown", "mouseup"];
            Object.entries(eN).forEach(([e, t]) => {
              t &&
                (y.includes(e)
                  ? p.push({ event: e, listener: eK })
                  : w.includes(e) && p.push({ event: e, listener: h }));
            }),
              Object.entries(eD).forEach(([e, t]) => {
                t &&
                  (y.includes(e)
                    ? p.push({ event: e, listener: eX })
                    : w.includes(e) && p.push({ event: e, listener: v }));
              }),
              b && p.push({ event: "pointermove", listener: ez });
            let g = () => {
                eE.current = !0;
              },
              _ = () => {
              ...
              x = E && (eD.mouseout || eD.mouseleave);
            return (
              x &&
                (null == (e = J.current) || e.addEventListener("mouseover", g),
                null == (t = J.current) || t.addEventListener("mouseout", _)),
              p.forEach(({ event: e, listener: t }) => {
                o.forEach((o) => {
                  var n;
                  null == (n = o.current) || n.addEventListener(e, t);
                });
              }),
              () => {
                var e, t;
                e$.scroll &&
                  ...
                  e$.resize
                    ...
                    : null == d || d(),
                  e$.clickOutsideAnchor &&
                    window.removeEventListener("click", eF),
                  ...
                  p.forEach(({ event: e, listener: t }) => {
                    o.forEach((o) => {
                      var n;
                      null == (n = o.current) || n.removeEventListener(e, t);
                    });
                  });
              }
            );
          }, [F, eY, es, ew, eT, T, O, L, eL, w, g]),
            (0, n.useEffect)(() => {
              var e, o;
              let n =
                null !=
                (o =
                  null != (e = null == ed ? void 0 : ed.anchorSelect) ? e : u)
                  ? o
                  : "";
              ...
              let r = new MutationObserver((e) => {
                ...
                e.forEach((e) => {
                      ...
                      if (n)
                        try {
                          r.push(...t.filter((e) => e.matches(n))),
                            r.push(
                              ...t.flatMap((e) => [...e.querySelectorAll(n)])
                            );
                        } catch (e) {}
                      t.some((e) => {
                        var t;
                        return (
                          !!(null == (t = null == e ? void 0 : e.contains)
                            ? void 0
                            : t.call(e, F)) &&
                          (eu(!1), ej(!1), q(null), e_(ee), e_(et), !0)
                        );
                      });
                    }
                    if (n)
                  ...
                  (o.length || r.length) &&
                    ek((e) => [...e.filter((e) => !r.includes(e)), ...o]);
              });
              return (
            ...
            }, [t, u, null == ed ? void 0 : ed.anchorSelect, F]),
            (0, n.useEffect)(() => {
              eY();
            }, [eY]),
            (0, n.useEffect)(() => {
              if (!(null == B ? void 0 : B.current)) return () => null;
            ...
            (0, n.useEffect)(() => {
              ...
              let t = document.querySelector(`[id='${a}']`),
                o = [...eT, t];
              (F && o.includes(F)) || q(null != (e = eT[0]) ? e : t);
            }, [a, eT, F]),
            (0, n.useEffect)(
              () => (
                M && ej(!0),
            ...
            }, [t, u, null == ed ? void 0 : ed.anchorSelect]),
            (0, n.useEffect)(() => {
              ee.current && (e_(ee), eH(w));
            }, [w]);
          let eZ = null != (U = null == ed ? void 0 : ed.content) ? U : H,
            eG = ei && Object.keys(er.tooltipStyles).length > 0;
          return (
            (0, n.useImperativeHandle)(e, () => ({
              open: (e) => {
                ...
                ef(null != e ? e : null),
                  (null == e ? void 0 : e.delay) ? eH(e.delay) : ej(!0);
              },
              close: (e) => {
                (null == e ? void 0 : e.delay) ? eB(e.delay) : ej(!1);
              },
              activeAnchor: F,
              place: er.place,
              isOpen: !!(es && !_ && eZ && eG),
            ...
            es && !_ && eZ
              ? n.createElement(
                  ...
                  n.createElement(y, {
                    ...
                    style: {
                      ...er.tooltipArrowStyles,
                      background: Z
                        ? `linear-gradient(to right bottom, transparent 50%, ${Z} 50%)`
                        : void 0,
                    },
                    ref: Q,
                  })
        ...
        ek = ({ content: e }) =>
          n.createElement("span", { dangerouslySetInnerHTML: { __html: e } }),
        eO = n.forwardRef(
          (
            {
              id: e,
            ...
            let [q, K] = (0, n.useState)(r),
              [X, Y] = (0, n.useState)(l),
              [Z, G] = (0, n.useState)(u),
              [U, J] = (0, n.useState)(a),
              [Q, ee] = (0, n.useState)(d),
              [et, eo] = (0, n.useState)(w),
              [en, er] = (0, n.useState)(g),
              [el, ei] = (0, n.useState)(b),
              [ec, es] = (0, n.useState)(_),
              [eu, ed] = (0, n.useState)(f),
              [ef, ep] = (0, n.useState)(m),
              [eh, ev] = (0, n.useState)(v),
              [ey, ew] = (0, n.useState)(null),
              [eg, eb] = (0, n.useState)(null),
              e_ = (0, n.useRef)(j),
              { anchorRefs: ex, activeAnchor: eE } = eS(e),
              eA = (e) =>
                null == e
                  ? void 0
                      ...
                      return (
                        o.startsWith("data-tooltip-") &&
                          (t[o.replace(/^data-tooltip-/, "")] =
                            null != (n = null == e ? void 0 : e.getAttribute(o))
                              ? n
                              : null),
                        t
                      );
              ...
              eR = (e) => {
                let t = {
                  ...
                  "delay-show": (e) => {
                    eo(null === e ? w : Number(e));
                  },
                  "delay-hide": (e) => {
                    er(null === e ? g : Number(e));
                  },
                  float: (e) => {
                    ei(null === e ? b : "true" === e);
                  },
                ...
                "undefined" != typeof window &&
                  window.dispatchEvent(
                    new CustomEvent("react-tooltip-inject-styles", {
                      detail: { disableCore: "core" === j, disableBase: j },
                    })
                  );
              }, []),
              (0, n.useEffect)(() => {
                ...
                if (
                  ...
                  try {
                    ...
                    console.warn(
                      `[react-tooltip] "${l}" is not a valid CSS selector`
                    );
                  }
                let i = document.querySelector(`[id='${t}']`);
                if ((i && r.add({ current: i }), !r.size)) return () => null;
                let c = null != (n = null != eg ? eg : i) ? n : eE.current,
              ...
              (0, n.useEffect)(() => {
                (null == C ? void 0 : C.border) &&
                  ...
                  H &&
                    !em("opacity", `${H}`) &&
                    console.warn(
                      `[react-tooltip] "${H}" is not a valid \`opacity\`.`
                    );
              }, []);
            let eO = p,
              eL = (0, n.useRef)(null);
            if (i) {
              let e = i({
                content:
                  (null == eg
                    ? void 0
                    : eg.getAttribute("data-tooltip-content")) ||
                  q ||
                  null,
                activeAnchor: eg,
              });
            ...
            X && (eO = n.createElement(ek, { content: X }));
            let eC = {
              forwardRef: V,
              id: e,
              anchorId: t,
              ...
              disableTooltip: z,
              activeAnchor: eg,
              setActiveAnchor: (e) => eb(e),
              role: F,
            };
            return n.createElement(eT, { ...eC });
          }
        );
      "undefined" != typeof window &&
              ...
              (e = l(
                ...
                (function (e) {
                  ...
                  if (
                    ...
                    return e.toString();
                  var t = "";
                  for (var o in e) n.call(e, o) && e[o] && (t = l(t, o));
                  return t;
                })(o)
              ));
          }
