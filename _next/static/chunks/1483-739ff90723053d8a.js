      ...
      var l = Object.defineProperty,
        ...
        u = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        h = (e, t) => {
          for (var i in t || (t = {})) p.call(t, i) && u(e, i, t[i]);
          if (d) for (var i of d(t)) c.call(t, i) && u(e, i, t[i]);
          return e;
        },
        m = (e, t) => n(e, o(t));
      let f = (0, s.forwardRef)((e, t) =>
        s.createElement(r.A, m(h({ ref: t }, e), { weights: a }))
      );
      f.displayName = "MagnifyingGlass";
    },
    27677: (e, t, i) => {
      "use strict";
      let s, r, a;
              ...
              r.currentTranslate > this.minTranslate() &&
                ...
                a.resistance &&
                  (r.currentTranslate =
                    this.minTranslate() -
                    1 +
                    (-this.minTranslate() + r.startTranslate + v) ** E)))
            : v < 0 &&
              (b &&
                y &&
                !i &&
              ...
              r.currentTranslate < this.maxTranslate() &&
                ...
                a.resistance &&
                  (r.currentTranslate =
                    this.maxTranslate() +
                    1 -
                    (this.maxTranslate() - r.startTranslate - v) ** E))),
      ...
      function S(e) {
        ...
        for (
          ...
          void 0 !== p[e + t]
            ? (m || (i >= p[e] && i < p[e + t])) &&
              ((f = e), (v = p[e + t] - p[e]))
            : (m || i >= p[e]) &&
              ((f = e), (v = p[p.length - 1] - p[p.length - 2]));
        }
        let g = null,
          w = null;
        l.rewind &&
        ...
        if (h > l.longSwipesMs) {
          ...
          "next" === s.swipeDirection &&
            (b >= l.longSwipesRatio
              ? s.slideTo(l.rewind && s.isEnd ? g : f + y)
              : s.slideTo(f)),
          ...
          (a.target === s.navigation.nextEl || a.target === s.navigation.prevEl)
            ? a.target === s.navigation.nextEl
              ? s.slideTo(f + y)
              : s.slideTo(f)
            : ("next" === s.swipeDirection && s.slideTo(null !== g ? g : f + y),
      ...
      let k = {
              ...
              for (let r = 0; r < h; r += 1) {
                ...
                if (
                  ...
                  if ("auto" === s.slidesPerView) {
                    P && (u[r].style[t.getDirectionLabel("width")] = "");
            ...
            updateSlidesProgress: function (e) {
              ...
              for (let e = 0; e < i.length; e += 1) {
                ...
                let d =
                  ...
                  m = c >= 0 && c <= this.size - this.slidesSizesGrid[e],
                  f =
                    (c >= 0 && c < this.size - 1) ||
                    (h > 1 && h <= this.size) ||
                    (c <= 0 && h >= this.size);
                f &&
                  ...
                  u(n, f, t.slideVisibleClass),
                  u(n, m, t.slideFullyVisibleClass),
                  (n.progress = s ? -d : d),
          ...
          slide: {
            ...
            slidePrev: function (e, t, i) {
              ...
              if (
                (void 0 !== f &&
                  ((v = l.indexOf(f)) < 0 && (v = s.activeIndex - 1),
          ...
          loop: {
            ...
            loopFix: function (e) {
              ...
              if (
                ((p.allowSlidePrev = !0),
                (p.allowSlideNext = !0),
                p.virtual && f.virtual.enabled)
              ) {
                i &&
                  (f.centeredSlides || 0 !== p.snapIndex
                    ? f.centeredSlides && p.snapIndex < f.slidesPerView
                      ? p.slideTo(
              ...
              "auto" === w
                ...
                : ((w = Math.ceil(parseFloat(f.slidesPerView, 10))),
                  v && w % 2 == 0 && (w += 1));
              let b = f.slidesPerGroupAuto ? w : f.slidesPerGroup,
                y = b;
              y % b != 0 && (y += b - (y % b)),
                (p.loopedSlides = y += f.loopAdditionalSlides);
              let S = p.grid && f.grid && f.grid.rows > 1;
              c.length < w + y ||
              ...
              let E = [],
                T = [],
                x = S ? Math.ceil(c.length / f.grid.rows) : c.length,
                M = l && x - g < w && !v,
                P = M ? g : p.activeIndex;
              void 0 === a
                ? (a = p.getSlideIndex(
              ...
              if (A < y) {
                ...
                (k = Math.max(A - (x - 2 * y), b)),
                  M && (k = Math.max(k, w - x + g + 1));
                for (let e = 0; e < k; e += 1) {
                  let t = e - Math.floor(e / x) * x;
                  S
                    ? c.forEach((e, i) => {
              ...
              if (
                ...
                "auto" === f.slidesPerView
                  ? p.updateSlides()
                  : S &&
                    ((E.length > 0 && O) || (T.length > 0 && C)) &&
                    p.slides.forEach((e, t) => {
                      p.grid.updateSlide(t, e, p.slides);
                    }),
                f.watchSlidesProgress && p.updateSlidesOffset(),
                i)
              ) {
                if (E.length > 0 && O) {
                  if (void 0 === t) {
                    let e = p.slidesGrid[P],
                      t = p.slidesGrid[P + L] - e;
                    d
                      ? p.setTranslate(p.translate - t)
                      : (p.slideTo(P + Math.ceil(L), 0, !1, !0),
                        r &&
                    ...
                    let e = S ? E.length / f.grid.rows : E.length;
      ...
      class _ {
        constructor() {
          ...
          let h = (0, o.w)({}, L, u);
          return (
            (l.params = (0, o.w)({}, h, A, t)),
            (l.originalParams = (0, o.w)({}, l.params)),
            (l.passedParams = (0, o.w)({}, t)),
            l.params &&
              l.params.on &&
        ...
        q = (0, l.forwardRef)(function (e, t) {
          ...
          return (
            ...
            R(() => {
              ...
              })(C, y.current, A, S.current, (e) => e.key);
              return (
                (y.current = C),
                (S.current = A),
                e.length &&
    ...
    38486: (e, t, i) => {
      ...
      function l(e) {
        let t,
          ...
          p,
          c,
          { swiper: u, extendParams: h, on: m, emit: f, params: v } = e;
        ...
        let S = () => {
          ...
          O = () => {
            if (u.destroyed || !u.autoplay.running) return;
            let e = (0, s.g)();
            "hidden" === e.visibilityState && ((p = !0), P(!0)),
              "visible" === e.visibilityState && C();
          },
          L = (e) => {
            "mouse" === e.pointerType &&
              ((p = !0), (c = !0), u.animating || u.autoplay.paused || P(!0));
          },
          k = (e) => {
            "mouse" === e.pointerType && ((c = !1), u.autoplay.paused && C());
          },
          A = () => {
          ...
          I = () => {
            (0, s.g)().addEventListener("visibilitychange", O);
          },
          z = () => {
            (0, s.g)().removeEventListener("visibilitychange", O);
          };
        m("init", () => {
          u.params.autoplay.enabled && (A(), I(), x());
        }),
          m("destroy", () => {
            _(), z(), u.autoplay.running && M();
          }),
          m("_freeModeStaticRelease", () => {
            (n || p) && C();
          }),
          m("_freeModeNoMomentumRelease", () => {
            u.params.autoplay.disableOnInteraction ? M() : P(!0, !0);
          }),
          m("beforeTransitionStart", (e, t, i) => {
            !u.destroyed &&
              u.autoplay.running &&
              (i || !u.params.autoplay.disableOnInteraction ? P(!0, !0) : M());
          }),
          m("sliderFirstMove", () => {
          ...
          m("touchEnd", () => {
            if (!u.destroyed && u.autoplay.running && l) {
              ...
              n && u.params.cssMode && C(), (n = !1), (l = !1);
            }
          }),
          m("slideChange", () => {
            !u.destroyed && u.autoplay.running && (d = !0);
          }),
          Object.assign(u.autoplay, { start: x, stop: M, pause: P, resume: C });
      }
    },
    52379: (e, t, i) => {
      "use strict";
