    ...
    56671: (t, e, a) => {
      ...
      let x = (t) => {
        ...
        let {
          ...
          tp = !1 !== b.dismissible,
          th = b.className || "",
          tg = b.descriptionClassName || "",
          tv = o.useMemo(
            () => S.findIndex((t) => t.toastId === b.id) || 0,
            [S, b.id]
          ),
          tb = o.useMemo(() => {
            var t;
            return null != (t = b.closeButton) ? t : R;
          }, [b.closeButton, R]),
          ty = o.useMemo(() => b.duration || A || 4e3, [b.duration, A]),
          tw = o.useRef(0),
          tx = o.useRef(0),
          tE = o.useRef(0),
          tk = o.useRef(null),
          [tN, tS] = I.split("-"),
          tM = o.useMemo(
            () => S.reduce((t, e, a) => (a >= tv ? t : t + e.height), 0),
            [S, tv]
          ),
          tT = f(),
          tB = b.invert || v,
          tC = "loading" === tf;
        (tx.current = o.useMemo(() => tv * L + tM, [tv, tM])),
          o.useEffect(() => {
            tl.current = ty;
          }, [ty]),
          o.useEffect(() => {
            ...
            (t.style.height = e),
              ...
              k((t) =>
                t.find((t) => t.toastId === b.id)
                  ? t.map((t) => (t.toastId === b.id ? { ...t, height: a } : t))
                  : [{ toastId: b.id, height: a, position: b.position }, ...t]
              );
          }, [q, b.title, b.description, k, b.id]);
            ...
            return (
              B || E || tT
                ...
                : tl.current !== 1 / 0 &&
                  ...
                  (t = setTimeout(() => {
                    null == b.onAutoClose || b.onAutoClose.call(b, b), tz();
                  }, tl.current))),
              () => clearTimeout(t)
            );
        }, [B, E, b, tf, tT, tz]),
        ...
        let tR = b.icon || (null == X ? void 0 : X[tf]) || n(tf);
        return o.createElement(
          "li",
          {
            tabIndex: 0,
            ...
            className: w(
              ...
              null == b || null == (e = b.classNames) ? void 0 : e.toast,
              null == V ? void 0 : V.default,
              null == V ? void 0 : V[tf],
              null == b || null == (a = b.classNames) ? void 0 : a[tf]
            ),
            "data-sonner-toast": "",
            "data-rich-colors": null != (h = b.richColors) ? h : z,
            ...
            style: {
              ...
              "--toasts-before": M,
              "--z-index": T.length - M,
              "--offset": `${G ? tr : tx.current}px`,
              "--initial-height": H ? "auto" : `${ts}px`,
              ...j,
              ...b.style,
            },
            onDragEnd: () => {
              Z(!1), O(null), (tk.current = null);
            },
            onPointerDown: (t) => {
              !tC &&
                tp &&
                ...
                "BUTTON" !== t.target.tagName &&
                  (Z(!0), (tk.current = { x: t.clientX, y: t.clientY })));
            },
            onPointerUp: () => {
              var t, e, a, o, r;
              if (tt || !tp) return;
            ...
            onPointerMove: (e) => {
              ...
              (Math.abs(d.x) > 0 || Math.abs(d.y) > 0) && to(!0),
                null == (o = tc.current) ||
                  o.style.setProperty("--swipe-amount-x", `${d.x}px`),
                null == (r = tc.current) ||
                  r.style.setProperty("--swipe-amount-y", `${d.y}px`);
            },
          },
          tb && !b.jsx && "loading" !== tf
            ? o.createElement(
                "button",
                {
                  ...
                  onClick:
                    tC || !tp
                      ? () => {}
                      : () => {
                          tz(), null == b.onDismiss || b.onDismiss.call(b, b);
                        },
                  className: w(
                    null == V ? void 0 : V.closeButton,
                    null == b || null == (r = b.classNames)
                      ? void 0
                      : r.closeButton
                  ),
                },
                null != (g = null == X ? void 0 : X.close) ? g : m
              )
            : null,
          (tf || b.icon || b.promise) &&
            null !== b.icon &&
            ((null == X ? void 0 : X[tf]) !== null || b.icon)
            ? o.createElement(
                "div",
                {
                  "data-icon": "",
                ...
                b.promise || ("loading" === b.type && !b.icon)
                  ? b.icon ||
                      (function () {
                        var t, e;
                        return (null == X ? void 0 : X.loading)
                          ? o.createElement(
                              "div",
                              {
                                className: w(
        ...
        let {
          ...
          T = o.useMemo(
            () =>
              Array.from(
                new Set(
                  [n].concat(S.filter((t) => t.position).map((t) => t.position))
                )
              ),
            [S, n]
          ),
                    ...
                    "ol",
                    {
                      ...
                      onFocus: (t) => {
                        !(
                          ...
                          (L.current ||
                            ((L.current = !0), (I.current = t.relatedTarget)));
                      },
                      onMouseEnter: () => R(!0),
                      onMouseMove: () => R(!0),
                      onMouseLeave: () => {
